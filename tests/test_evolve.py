...
class CommandTest(_Temp):
    ...
    def test_a_lineage_of_one_writes_the_section_alone(self):
        ...
        agg = json.loads((out_dir / "aggregate.json").read_text(encoding="utf-8"))
        self.assertEqual(list(agg), ["evolution", "coevolution", "data_evolution", "harness_evolution"], "the co-evolving eval and the data side always ride beside the section")
...
class RegistryTest(_Temp):
    ...
    def test_analyse_lineage_is_the_attach_pass_and_returns_the_section_unchanged(self):
        ...
        self.assertEqual(list(attached), ["evolution", "coevolution", "data_evolution", "harness_evolution"])
    ...
    def test_lineage_batch_is_the_last_pair_as_a_runs_batch_with_the_section_attached(self):
        ...
        agg = out["aggregate"]
        self.assertEqual(list(agg)[-4:], ["evolution", "coevolution", "data_evolution", "harness_evolution"], "the sections attach after the runs batch's own keys")
    ...
    def test_lineage_batch_without_a_pair_still_attaches_the_section(self):
        ...
        self.assertEqual(list(out["aggregate"]), ["evolution", "coevolution", "data_evolution", "harness_evolution"])
