...
(function (global) {
  ...
  var CSS = [
    ".ig-lead{font-size:var(--fs-m);line-height:1.5;margin:0 0 8px;color:var(--ink)}",
    ".ig-lead b{font-weight:650}",
    ".ig-sub{font-size:var(--fs-xs);color:var(--ink-3);margin:0 0 8px;line-height:1.45}",
    ...
    ".ig-name{font-weight:620;font-size:var(--fs-s);overflow:hidden;text-overflow:ellipsis;",
    "white-space:nowrap;max-width:100%;min-width:0}",
    ".ig-note{font-size:var(--fs-xs);line-height:1.45;color:var(--ink-2);margin:5px 0 0}",
    ".ig-mini{font-size:var(--fs-xs);line-height:1.45;color:var(--ink-3);margin:5px 0 0}",
    ".ig-tags{display:flex;flex-wrap:wrap;gap:4px;margin-top:6px}",
    ".ig-chip{font-family:var(--mono);font-size:var(--fs-xs);color:var(--ink-2);background:var(--surface-2);",
    ...
    "padding:3px 8px;font-size:var(--fs-xs);font-weight:650;letter-spacing:-.01em;",
    "border:1px solid var(--rule-2);background:var(--surface-2);color:var(--ink-2)}",
    ".ig-verdict .gl{font-size:var(--fs-s);line-height:1}",
    ...
    ".ig-why{font-size:var(--fs-xs);line-height:1.45;margin:6px 0 0;padding-left:7px;color:var(--ink-2)}",
    ...
    ".ig-quad .hd{font-size:var(--fs-xs);text-transform:uppercase;letter-spacing:.08em;",
    "color:var(--ink-3);align-self:end;padding-bottom:2px}",
    ".ig-quad .rw{font-size:var(--fs-xs);text-transform:uppercase;letter-spacing:.08em;",
    ...
    ".ig-cell .lab{font-size:var(--fs-xs);line-height:1.3;color:var(--ink-3)}",
    ...
    /* flag matrix */
    "table.ig-mx{border-collapse:collapse;width:100%;font-size:var(--fs-xs)}",
    ".ig-mx th{font-size:var(--fs-xs);text-transform:uppercase;letter-spacing:.07em;color:var(--ink-3);",
    ...
    ".ig-mx .dag{font-size:var(--fs-xs);color:var(--ink-3);vertical-align:super;margin-left:1px}",
    ...
    ".ig-row{display:flex;gap:6px;align-items:baseline;font-size:var(--fs-xs);padding:3px 0;",
    ...
    "font-size:var(--fs-xs);font-weight:640;color:var(--ink-2)}",
    ".ig-unmeas .hd>.ig-badge{flex:none}",
    ".ig-unmeas .hd>span:last-child{flex:1 1 130px;min-width:0}",
    ".ig-unmeas p{margin:4px 0 0;font-size:var(--fs-xs);line-height:1.45;color:var(--ink-2)}",
    ".ig-unmeas b{color:var(--ink)}",
    ".ig-badge{display:inline-flex;align-items:center;gap:4px;border:1px dashed var(--rule-2);",
    "border-radius:999px;padding:0 7px;font-size:var(--fs-xs);color:var(--ink-3);background:var(--surface)}",
    ".ig-basis{display:inline-flex;align-items:center;gap:4px;font-size:var(--fs-xs);color:var(--ink-3);",
