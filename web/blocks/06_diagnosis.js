  ...
  function ensureStyle() {
    ...
    try {
      ...
      node.textContent = [
        ...
        ".dx-verdict .k{display:block;font-size:var(--fs-xs);text-transform:uppercase;",
        ...
        ".dx-decisive .k{display:block;font-size:var(--fs-xs);text-transform:uppercase;",
        "letter-spacing:.08em;color:var(--ink-3);font-weight:700;margin-bottom:3px}",
        ".dx-decisive b{color:var(--accent)}",
        ".dx-decisive .dx-crit{display:block;font-size:var(--fs-xs);color:var(--ink-3);",
        "margin-top:2px}",
        ...
        ".dx-kind{font-family:var(--mono);font-size:var(--fs-xs);color:var(--ink-3)}",
        ".dx-score{font-family:var(--mono);font-size:var(--fs-xs);color:var(--ink-2);",
        "font-variant-numeric:tabular-nums;flex:none}",
        ".dx-statement{display:block;font-size:var(--fs-s);line-height:1.5;color:var(--ink)}",
        ".dx-part{font-size:var(--fs-xs);color:var(--ink-3);font-style:italic}",
        ".dx-row.dim .dx-statement{color:var(--ink-3)}",
        ".dx-row.struck .dx-statement{text-decoration:line-through;color:var(--ink-3)}",
        ".dx-caret{flex:none;color:var(--ink-3);font-size:var(--fs-xs);",
        ...
        ".dx-h{font-size:var(--fs-xs);text-transform:uppercase;letter-spacing:.06em;",
        "color:var(--ink-3);font-weight:700;margin:6px 0 3px}",
        ".dx-ev{list-style:none;margin:0;padding:0}",
        ".dx-ev li{font-size:var(--fs-xs);line-height:1.55;color:var(--ink-2);",
        "padding:2px 0;word-break:break-word}",
        ".dx-quote{font-family:var(--mono);font-size:var(--fs-xs);background:var(--surface-2);",
        "border:1px solid var(--rule);border-radius:5px;padding:0 4px}",
        ".dx-path{font-family:var(--mono);font-size:var(--fs-xs)}",
        ".dx-basis{display:inline-block;margin-left:6px;font-size:var(--fs-xs);",
        ...
        ".dx-settle{font-size:var(--fs-xs);line-height:1.55;color:var(--ink-2);margin:6px 0 0}",
        ...
        ".dx-causal-title{flex:1;font-size:var(--fs-xs);text-transform:uppercase;",
        ...
        ".dx-cstep{display:block;font-size:var(--fs-s);line-height:1.5;color:var(--ink)}",
        ".dx-cstep .n{font-family:var(--mono);font-size:var(--fs-xs);color:var(--ink-2)}",
        ".dx-mech{display:block;font-size:var(--fs-xs);line-height:1.5;color:var(--ink-3);",
        "margin-top:1px;padding-left:8px;border-left:2px solid var(--rule-2)}",
        ".dx-mech.soft{font-style:italic;border-left-style:dashed}",
        ".dx-ceid{display:block;font-family:var(--mono);font-size:var(--fs-xs);",
        ...
        ".dx-tension .k{font-size:var(--fs-xs);text-transform:uppercase;letter-spacing:.08em;",
