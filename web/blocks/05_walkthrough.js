  ...
  function ensureStyle() {
    ...
    try {
      ...
      node.textContent = [
        ...
        "color:var(--ink-2);font-size:var(--fs-xs);font-weight:700;font-variant-numeric:tabular-nums}",
        ".wt-story>li:not(:last-child)::after{content:\"\";position:absolute;left:10.5px;",
        "top:27px;bottom:3px;width:1px;background:var(--rule)}",
        ".wt-k{font-size:var(--fs-xs);text-transform:uppercase;letter-spacing:.08em;",
        "color:var(--ink-3);font-weight:700;margin:2px 0 4px}",
        ".wt-p{font-size:var(--fs-m);line-height:1.62;color:var(--ink);margin:0}",
        ".wt-p+.wt-p{margin-top:7px}",
        ".wt-p .said{color:var(--ink-2)}",
        ".wt-quote{font-family:var(--mono);font-size:var(--fs-xs);background:var(--surface-2);",
        ...
        "color:var(--accent);border-radius:999px;padding:0 8px 0 6px;font-size:var(--fs-xs);",
        "line-height:1.7;cursor:pointer;white-space:nowrap;font-family:var(--sans)}",
        ".wt-ev::before{content:\"⌖\";font-size:var(--fs-xs);line-height:1}",
