  ...
  function ensureStyle() {
    ...
    try {
      ...
      node.textContent = [
        ...
        ".vz-lead-n{font-size:var(--fs-xxl);font-weight:660;letter-spacing:-.02em;color:var(--ink);",
        "font-variant-numeric:tabular-nums;line-height:1.05}",
        ".vz-lead-t{font-size:var(--fs-s);font-weight:600;color:var(--ink)}",
        ".vz-lead-b{font-size:var(--fs-s);color:var(--ink-2);line-height:1.5}",
        ".vz-h{font-size:var(--fs-xs);text-transform:uppercase;letter-spacing:.06em;",
        "color:var(--ink-3);margin:13px 0 6px}",
        ".vz-h:first-child{margin-top:0}",
        ".vz-sub{font-size:var(--fs-xs);color:var(--ink-3);line-height:1.45}",
        ".vz-line{font-size:var(--fs-s);color:var(--ink);line-height:1.5}",
        ...
        ".vz-metric-head b{font-size:var(--fs-m);color:var(--ink);letter-spacing:-.01em}",
        ".vz-chips{display:flex;flex-wrap:wrap;gap:5px 9px;align-items:center;",
        "margin:6px 0 0;font-size:var(--fs-xs);color:var(--ink-3)}",
        ...
        "border-radius:6px;padding:3px 9px;font-size:var(--fs-xs);cursor:pointer;font-family:inherit}",
        ...
        "margin:10px 0 0;font-size:var(--fs-s);line-height:1.5;color:var(--ink-2);background:var(--surface-2)}",
        ".vz-fix b{color:var(--ink);display:block;font-size:var(--fs-xs);text-transform:uppercase;",
