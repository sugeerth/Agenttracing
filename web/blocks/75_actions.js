  ...
  function ensureStyle() {
    ...
    try {
      ...
      node.textContent = [
        ...
        "padding:8px 10px;margin:0 0 10px;font-size:var(--fs-s);line-height:1.5;color:var(--ink)}",
        ".ax-gate .k{font-weight:700;color:var(--warn);white-space:nowrap}",
        ".ax-gate .sub{color:var(--ink-2);font-size:var(--fs-xs);margin-top:3px}",
        ...
        "color:var(--ink-2);border-radius:7px;padding:4px 12px;font:600 var(--fs-s)/1.4 inherit;cursor:pointer}",
        ...
        "border:1px solid var(--rule-2);font-size:var(--fs-xs);font-weight:700;color:var(--ink-2);",
        "font-variant-numeric:tabular-nums}",
        ".ax-main{flex:1 1 auto;min-width:0}",
        ".ax-act{font-size:var(--fs-m);font-weight:600;line-height:1.45;overflow-wrap:anywhere}",
        ".ax-meta{display:flex;flex-wrap:wrap;gap:5px;align-items:center;margin-top:5px;",
        "font-size:var(--fs-xs);color:var(--ink-3)}",
        ".ax-impact{font-size:var(--fs-xs);color:var(--ink-2);margin-top:4px;line-height:1.45;",
        "overflow-wrap:anywhere}",
        ".ax-impact .none{color:var(--ink-3);font-style:italic}",
        ".ax-caret{flex:0 0 auto;color:var(--ink-3);font-size:var(--fs-xs);padding-top:5px;",
        ...
        ".ax-k{font-size:var(--fs-xs);text-transform:uppercase;letter-spacing:.08em;",
        "color:var(--ink-3);font-weight:700;margin:0 0 5px}",
        ".ax-p{font-size:var(--fs-s);line-height:1.55;color:var(--ink);margin:0 0 5px}",
        ".ax-ul{margin:0;padding-left:16px;font-size:var(--fs-s);line-height:1.55;color:var(--ink)}",
        ".ax-ul li{margin:0 0 3px}",
        ".ax-basis{font-family:var(--mono);font-size:var(--fs-xs);line-height:1.6;color:var(--ink-2);",
        "margin:0;padding-left:14px}",
        ".ax-basis li{margin:0 0 2px;overflow-wrap:anywhere}",
        ".ax-fp{font-family:var(--mono);font-size:var(--fs-xs);background:var(--surface-2);",
        ...
        ".ax-caveat{font-size:var(--fs-xs);color:var(--ink-3);line-height:1.5;margin:5px 0 0}",
        ".ax-prehead{display:flex;align-items:center;justify-content:space-between;gap:8px;",
        "margin:0 0 4px}",
        ".ax-prehead span{font-size:var(--fs-xs);font-weight:700;color:var(--ink-2)}",
        ".ax-pre{margin:0;background:var(--surface-2);border:1px solid var(--rule);",
        "border-radius:7px;padding:8px 10px;font-size:var(--fs-xs);line-height:1.55;",
        ...
        ".ax-check .what{font-size:var(--fs-s);line-height:1.5;color:var(--ink)}",
        ".ax-check .how{font-size:var(--fs-xs);color:var(--ink-3);margin-top:2px;line-height:1.5}",
        ...
        "padding:7px 9px;margin:6px 0 0;font-size:var(--fs-s);line-height:1.55;color:var(--ink);",
        "font-weight:600}",
        ".ax-luck .lbl{display:block;font-size:var(--fs-xs);font-weight:700;letter-spacing:.08em;",
        ...
        "padding:0 8px;font-size:var(--fs-xs);line-height:1.8;font-family:var(--mono);",
        ...
        "font-family:var(--sans);font-size:var(--fs-xs);color:var(--ink-2);display:flex;",
        "align-items:center;gap:6px;text-align:left}",
        ".ax-foot-toggle:hover{color:var(--accent)}",
        ".ax-refusal{border-top:1px solid var(--rule);padding:7px 0;font-size:var(--fs-s);",
        "line-height:1.5;min-width:0}",
        ".ax-refusal:first-of-type{border-top:0}",
        ".ax-refusal .why{font-weight:700;color:var(--ink-2)}",
        ".ax-refusal .det{font-size:var(--fs-xs);color:var(--ink-3);margin-top:2px;line-height:1.5;",
        "overflow-wrap:anywhere}",
