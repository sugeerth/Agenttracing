  ...
  function ensureStyle() {
    ...
    try {
      ...
      node.textContent = [
        ...
        ".ax-k{font-size:10.5px;text-transform:uppercase;letter-spacing:.08em;",
        ...
        ".ax-fp{font-family:var(--mono);font-size:10.5px;background:var(--surface-2);",
        ...
        "font-weight:600}",
        ".ax-luck .lbl{display:block;font-size:10px;font-weight:700;letter-spacing:.08em;",
        ...
        "padding:0 8px;font-size:10.5px;line-height:1.8;font-family:var(--mono);",
