  ...
  function ensureStyle() {
    ...
    try {
      ...
      node.textContent = [
        ...
        ".sig-line{font-size:var(--fs-s);color:var(--ink)}",
        ".sig-sub{font-size:var(--fs-xs);color:var(--ink-3);line-height:1.45}",
        ".sig-chips{display:flex;flex-wrap:wrap;gap:4px;margin-top:4px;align-items:center}",
        ".sig-legend{display:flex;flex-wrap:wrap;gap:11px;font-size:var(--fs-xs);",
