...
(function (global) {
  ...
  function ensureStyle() {
    ...
    node.textContent = [
      ...
      ".dbg-kpi th.h{color:var(--ink-3);font-family:var(--mono);font-size:var(--fs-xs);font-weight:500;text-align:right;padding:0 10px 4px 0}",
      ...
      ".dbg-strip table{border-collapse:separate;border-spacing:2px 0;font-size:var(--fs-xs)}",
      ...
      ".dbg-cell .m{position:absolute;right:1px;top:-1px;font-size:var(--fs-xs);color:var(--ink);line-height:1;font-family:var(--mono)}",
      ".dbg-cell .m.warn{color:var(--bad)}",
      ".dbg-cell .i{position:absolute;left:3px;bottom:1px;font-size:var(--fs-xs);color:var(--ink-3);font-family:var(--mono)}",
      ...
      ".dbg-legend{display:flex;gap:12px;flex-wrap:wrap;font-size:var(--fs-xs);color:var(--ink-3);margin:6px 0 10px}",
      ...
      ".dbg-run h5 .st{font-family:var(--mono);font-weight:500;font-size:var(--fs-xs);color:var(--ink-3);margin-left:auto}",
      ...
      ".dbg-layer .k{font-family:var(--mono);color:var(--ink-3);font-size:var(--fs-xs);padding-top:1px}",
      ...
      ".dbg-layer pre{margin:3px 0 0;white-space:pre-wrap;word-break:break-word;font-family:var(--mono);font-size:var(--fs-xs);color:var(--ink-2);background:var(--surface-2);border-radius:5px;padding:5px 7px;max-height:120px;overflow:auto}",
      ".dbg-layer .tag{display:inline-block;font-family:var(--mono);font-size:var(--fs-xs);padding:0 6px;border-radius:8px;background:var(--surface-2);color:var(--ink-2);margin:0 4px 2px 0}",
