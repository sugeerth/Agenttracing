...
- No visible `.empty` in an open block; no console error or warning, unfiltered, across all nine views (Chat, Levels, Story, Evidence, Batch, Panels, Training, Evolution, Evals).
