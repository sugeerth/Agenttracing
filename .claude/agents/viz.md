...
- No visible `.empty` in an open block; no console error or warning, unfiltered, across all seven views (Story, Evidence, Batch, Panels, Training, Evolution, Evals).
